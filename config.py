...
CURIOSITY_TOPICS = [
    ...
    "misterios do universo observavel",
    "curiosidades sobre meteoros e asteroides",
    "fatos sobre exploracao espacial",
    "fatos surpreendentes sobre o corpo humano",
    "curiosidades sobre o cerebro humano",
    "ilusoes de otica que enganam o cerebro",
    "por que sonhamos",
    "memoria humana e falsas lembrancas",
    "descobertas cientificas recentes",
    "experimentos cientificos estranhos",
    "fatos cientificos contraintuitivos",
    ...
    "segredos da Roma antiga",
    "descobertas arqueologicas inexplicaveis",
    ...
    "objetos comuns com origens surpreendentes",
    "recordes mundiais bizarros",
    "coisas que parecem falsas mas sao reais",
    "lugares abandonados com historias estranhas",
    "habitos humanos curiosos ao redor do mundo",
]
